...
This clustering was helpful to further understand the projects goals and important framework.Successively to the affinity clustering, we were able to create 3different personas that described their user needs respectively. The full description of the personas is found [here](https://github.com/eth-ait/hci-project-group9/blob/master/Deliverables/Personas.pdf)[PDF, 3 Pages].
